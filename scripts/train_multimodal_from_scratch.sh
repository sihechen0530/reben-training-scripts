...
# This script trains both backbones without using pretrained weights
...
# DINOv3 configuration - train from scratch (no pretrained weights)
...
# ResNet101 configuration - train from scratch (no pretrained weights)
